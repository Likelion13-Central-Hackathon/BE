...
public class ReportGeneratorImpl implements ReportGenerator {
    ...
    public Report generate(Idea idea, String ideaFullInfoText, String title) {
        ...
        String anglePrompt = """
                ...
                각도: 92
                주간핵심제안:
                🤖 **Google Veo 3 / 당근마켓에 활용 추천**
                  최근 공개된 'Google Veo 3'는 고해상도 영상과 동기화 오디오를 자동 생성하고 Veo 3 Fast는 짧은 광고·데모 영상 제작에 최적화됨
